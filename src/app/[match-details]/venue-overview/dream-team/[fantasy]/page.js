...
import FantasyMain from "@/components/new/venue-overview/dream-team/fantasy/FantasyMain";
...
const Page = async ({ params }) => {
  ...
  // console.log(FantasyOverview, "FantasyOverviewFantasyOverviewFantasyOverview");
      ...
      <div className={styles.mainContent}>
        ...
        <div className={`${styles.allContent} mt-2`}>
          <div className={`${styles.container1} mt-2`}>
            ...
            />
            <FantasyMain FantasyOverview={FantasyOverview} matchId={match_id} />
          </div>
