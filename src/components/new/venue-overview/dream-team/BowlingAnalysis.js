      ...
      <div className="bg-white shadow-sm p-4 border border-gray-200 rounded-lg">
        <div className="mb-4">
          <h4 className="text-primary text-sm font-bold">
            (Bowling analysis) fantasy points contribution by position
          </h4>
          <p className="text-gray-500 text-xs">
            Breakdown of bowling points into points earned by pace bowlers and
            spin bowlers appearing in the dream team of the last played at this
            venue
          </p>
        </div>
